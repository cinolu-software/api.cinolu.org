...
export class AppReviews1731660578110 implements MigrationInterface {
  name = 'AppReviews1731660578110';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`application\` DROP COLUMN \`reviewer_comment\``);
    await queryRunner.query(`ALTER TABLE \`application\` DROP COLUMN \`applied_at\``);
    await queryRunner.query(`ALTER TABLE \`application\` ADD \`answers\` json NOT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`application\` DROP COLUMN \`answers\``);
    await queryRunner.query(`ALTER TABLE \`application\` ADD \`applied_at\` datetime NULL DEFAULT 'NULL'`);
    await queryRunner.query(`ALTER TABLE \`application\` ADD \`reviewer_comment\` text NULL DEFAULT 'NULL'`);
    await queryRunner.query(
      `ALTER TABLE \`application\` ADD \`status\` enum ('pending', 'shortlisted', 'accepted', 'rejected') NOT NULL DEFAULT ''pending''`
    );
