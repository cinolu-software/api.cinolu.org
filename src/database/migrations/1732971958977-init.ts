...
export class Init1732971958977 implements MigrationInterface {
  name = 'Init1732971958977';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`requirement\` DROP FOREIGN KEY \`FK_ed3de91a28a36881c5e90283fdd\``);
    await queryRunner.query(
      `ALTER TABLE \`review\` CHANGE \`reviwerId\` \`reviwerId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`review\` CHANGE \`applicationId\` \`applicationId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`application\` CHANGE \`userId\` \`userId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`application\` CHANGE \`programId\` \`programId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`user\` CHANGE \`address\` \`address\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`event\` CHANGE \`responsibleId\` \`responsibleId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`event\` CHANGE \`online_link\` \`online_link\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`event\` CHANGE \`image\` \`image\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`detail\` CHANGE \`userId\` \`userId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`program\` CHANGE \`town\` \`town\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`program\` CHANGE \`prize\` \`prize\` text CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`program\` CHANGE \`aim\` \`aim\` text CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`program\` CHANGE \`image\` \`image\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`program\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`partner\` CHANGE \`profile\` \`profile\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`partner\` CHANGE \`website_link\` \`website_link\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`phase\` CHANGE \`programId\` \`programId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(`ALTER TABLE \`phase\` DROP COLUMN \`form\``);
    ...
    await queryRunner.query(
      `ALTER TABLE \`document\` CHANGE \`programId\` \`programId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`document\` CHANGE \`file_name\` \`file_name\` varchar(255) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`requirement\` CHANGE \`phaseId\` \`phaseId\` varchar(36) CHARACTER SET "latin1" COLLATE "latin1_swedish_ci" NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
