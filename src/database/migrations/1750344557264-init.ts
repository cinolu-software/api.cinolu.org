...
export class Init1750344557264 implements MigrationInterface {
  name = 'Init1750344557264';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`project\` DROP COLUMN \`started_at\``);
    await queryRunner.query(`ALTER TABLE \`project\` ADD \`started_at\` date NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`project\` DROP COLUMN \`ended_at\``);
    await queryRunner.query(`ALTER TABLE \`project\` ADD \`ended_at\` date NOT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`enterprise\` CHANGE \`location\` \`location\` varchar(255) NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`enterprise\` CHANGE \`linkedin_url\` \`linkedin_url\` varchar(255) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`enterprise\` CHANGE \`website\` \`website\` varchar(255) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`enterprise\` CHANGE \`phone_number\` \`phone_number\` varchar(255) NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`enterprise\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`product\` CHANGE \`enterpriseId\` \`enterpriseId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`product_image\` CHANGE \`productId\` \`productId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`product_image\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`product_image\` ADD CONSTRAINT \`FK_40ca0cd115ef1ff35351bed8da2\` FOREIGN KEY (\`productId\`) REFERENCES \`product\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE \`product_category\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`post_category\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(`ALTER TABLE \`post_views\` CHANGE \`postId\` \`postId\` varchar(36) NULL DEFAULT 'NULL'`);
    await queryRunner.query(
      `ALTER TABLE \`post_views\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`post_views\` ADD CONSTRAINT \`FK_a05ca4e99f3345db11cfe91ee6e\` FOREIGN KEY (\`postId\`) REFERENCES \`post\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    ...
    await queryRunner.query(`ALTER TABLE \`project\` DROP COLUMN \`ended_at\``);
    await queryRunner.query(`ALTER TABLE \`project\` ADD \`ended_at\` datetime NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`project\` DROP COLUMN \`started_at\``);
    await queryRunner.query(`ALTER TABLE \`project\` ADD \`started_at\` datetime NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`project\` DROP COLUMN \`report\``);
    await queryRunner.query(
