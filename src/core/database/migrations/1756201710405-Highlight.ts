...
export class Highlight1756201710405 implements MigrationInterface {
    name = 'Highlight1756201710405'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`article\` ADD \`is_highlighted\` tinyint NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`event\` ADD \`is_highlighted\` tinyint NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`program\` ADD \`is_highlighted\` tinyint NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`subprogram\` ADD \`is_highlighted\` tinyint NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`project\` ADD \`is_highlighted\` tinyint NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`role\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`role\` CHANGE \`label\` \`label\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`role\` CHANGE \`label\` \`label\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`role\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`project\` DROP COLUMN \`is_highlighted\``);
        await queryRunner.query(`ALTER TABLE \`subprogram\` DROP COLUMN \`is_highlighted\``);
        await queryRunner.query(`ALTER TABLE \`program\` DROP COLUMN \`is_highlighted\``);
        await queryRunner.query(`ALTER TABLE \`event\` DROP COLUMN \`is_highlighted\``);
        await queryRunner.query(`ALTER TABLE \`article\` DROP COLUMN \`is_highlighted\``);
    }
