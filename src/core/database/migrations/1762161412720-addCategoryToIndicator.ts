...
export class AddCategoryToIndicator1762161412720 implements MigrationInterface {
  name = 'AddCategoryToIndicator1762161412720';
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`indicator\` ADD \`category\` varchar(255) NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`indicator\` DROP COLUMN \`category\``);
  }
}
