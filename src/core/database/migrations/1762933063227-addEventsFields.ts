...
export class AddEventsFields1762933063227 implements MigrationInterface {
    name = 'AddEventsFields1762933063227'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`event\` ADD \`context\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`event\` ADD \`objectives\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`event\` ADD \`duration_hours\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`event\` ADD \`selection_criteria\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`managedEventsId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`managedProjectsId\` \`managedProjectsId\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`venture\` ADD CONSTRAINT \`FK_6fbaf21ef151926c152487526d7\` FOREIGN KEY (\`ownerId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`managedProjectsId\` \`managedProjectsId\` varchar(36) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`event\` DROP COLUMN \`selection_criteria\``);
        await queryRunner.query(`ALTER TABLE \`event\` DROP COLUMN \`duration_hours\``);
        await queryRunner.query(`ALTER TABLE \`event\` DROP COLUMN \`objectives\``);
        await queryRunner.query(`ALTER TABLE \`event\` DROP COLUMN \`context\``);
        await queryRunner.query(`ALTER TABLE \`project\` ADD \`conclusion\` text NULL DEFAULT 'NULL'`);
