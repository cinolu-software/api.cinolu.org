...
export class AddForm1763646890925 implements MigrationInterface {
  name = 'AddForm1763646890925';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`phase_form\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`title\` varchar(255) NOT NULL, \`description\` text NULL, \`fields\` json NOT NULL, \`is_active\` tinyint NOT NULL DEFAULT 1, \`phaseId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`project\` CHANGE \`projectManagerId\` \`projectManagerId\` varchar(36) NULL`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`resource\` ADD CONSTRAINT \`FK_452eccdc36bc855df2dd1e1e3f6\` FOREIGN KEY (\`phaseId\`) REFERENCES \`phase\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE \`resource\` ADD CONSTRAINT \`FK_ba509a0a92e7d2778e75416e756\` FOREIGN KEY (\`projectId\`) REFERENCES \`project\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE \`phase_form\` ADD CONSTRAINT \`FK_2738fe40d93428a642ec5d54885\` FOREIGN KEY (\`phaseId\`) REFERENCES \`phase\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`project\` CHANGE \`projectManagerId\` \`projectManagerId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`project\` CHANGE \`selection_criteria\` \`selection_criteria\` text NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`project\` CHANGE \`duration_hours\` \`duration_hours\` int NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`resource\` CHANGE \`projectId\` \`projectId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`resource\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`resource\` ADD CONSTRAINT \`FK_ba509a0a92e7d2778e75416e756\` FOREIGN KEY (\`projectId\`) REFERENCES \`project\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`indicator\` CHANGE \`programId\` \`programId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`indicator\` CHANGE \`category\` \`category\` varchar(255) NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`metric\` CHANGE \`projectId\` \`projectId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(`ALTER TABLE \`metric\` CHANGE \`eventId\` \`eventId\` varchar(36) NULL DEFAULT 'NULL'`);
    await queryRunner.query(
      `ALTER TABLE \`metric\` CHANGE \`indicatorId\` \`indicatorId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`metric\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`metric\` ADD CONSTRAINT \`FK_e349d5c307cf8c81c38cd95b699\` FOREIGN KEY (\`projectId\`) REFERENCES \`project\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`event\` CHANGE \`eventManagerId\` \`eventManagerId\` varchar(36) NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`event\` CHANGE \`selection_criteria\` \`selection_criteria\` text NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`event\` CHANGE \`duration_hours\` \`duration_hours\` int NULL DEFAULT 'NULL'`
    );
    ...
    await queryRunner.query(`DROP TABLE \`phase_form\``);
  }
}
