...
export class AddTargetToIndicator1761547768913 implements MigrationInterface {
    name = 'AddTargetToIndicator1761547768913'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`metric\` DROP COLUMN \`is_public\``);
        await queryRunner.query(`ALTER TABLE \`indicator\` ADD \`target\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`indicator\` ADD \`year\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`indicator\` DROP COLUMN \`year\``);
        await queryRunner.query(`ALTER TABLE \`indicator\` DROP COLUMN \`target\``);
        await queryRunner.query(`ALTER TABLE \`metric\` ADD \`is_public\` tinyint NOT NULL DEFAULT '0'`);
    }
