...
export class FixRelations1762955709199 implements MigrationInterface {
  name = 'FixRelations1762955709199';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_60798ffa140580aee71178b9cf5\``);
    ...
    await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`managedEventsId\``);
    await queryRunner.query(`ALTER TABLE \`event\` ADD \`eventManagerId\` varchar(36) NULL`);
    await queryRunner.query(`ALTER TABLE \`project\` ADD \`projectManagerId\` varchar(36) NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`project\` DROP COLUMN \`projectManagerId\``);
    await queryRunner.query(`ALTER TABLE \`event\` DROP COLUMN \`eventManagerId\``);
    await queryRunner.query(`ALTER TABLE \`user\` ADD \`managedEventsId\` varchar(36) NULL DEFAULT 'NULL'`);
    await queryRunner.query(`ALTER TABLE \`user\` ADD \`managedProjectsId\` varchar(36) NULL DEFAULT 'NULL'`);
    await queryRunner.query(
      `ALTER TABLE \`user\` ADD CONSTRAINT \`FK_754d5f1a6c9c14de8a4032d3b49\` FOREIGN KEY (\`managedProjectsId\`) REFERENCES \`project\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE \`user\` ADD CONSTRAINT \`FK_60798ffa140580aee71178b9cf5\` FOREIGN KEY (\`managedEventsId\`) REFERENCES \`event\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
}
