...
export class AddProjectsFieldsM11762871397802 implements MigrationInterface {
    name = 'AddProjectsFieldsM11762871397802'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`project\` CHANGE \`conclusion\` \`conclusion\` text NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`project\` CHANGE \`conclusion\` \`conclusion\` text NULL DEFAULT 'NULL'`);
